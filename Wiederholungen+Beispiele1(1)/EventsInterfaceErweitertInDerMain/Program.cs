...
namespace EventsInterfaceErweitertInDerMain
{
    ...
    class Program
    {
        static List<IMitarbeiterBegrüßenKunde> BegrüßenKundeListe = new List<IMitarbeiterBegrüßenKunde>();
        ...
        static void Main(string[] args)
        {
            ...
            Mitarbeiter ma2 = new Mitarbeiter("James");
            Geschäftsführer g = new Geschäftsführer();

            BegrüßenKundeListe.Add(ma1);
            BegrüßenKundeListe.Add(ma2);
            BegrüßenKundeListe.Add(g);


            BegrüßenKundeEventAbonnieren(e);
        ...
        public static void BegrüßenKundeEventAbonnieren(Einkaufzentrum e)
        {
            foreach (IMitarbeiterBegrüßenKunde m in BegrüßenKundeListe)
            {
                e.NeuerKundeHatDasGebäudeBetreten += m.Grüßen;
            }
        }
